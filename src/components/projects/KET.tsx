...
const KET = () => {
	return (
		<article>
			...
			<p>Of course, the proof's in the pudding. Go watch some excellent public media content at <a href='https://ket.org' target="_blank">KET.org</a>. I'm really proud of the work we do at KET and really enjoy providing this service to my state! If you want to know details about my specific roles and responsibilities at KET, my previous work experience, or my education, <ResumeDownload />!</p>
		</article>
	)
}
